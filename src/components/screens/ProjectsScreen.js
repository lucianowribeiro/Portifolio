    ...
    <>
      ...
      <Box width="80%" display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'center ', md: 'space-around' }}>
        ...
        <Box width={{ xs: '100%', md: '50%' }} display="flex" flexDirection="column" justifyContent="center" alignItems="center">
          ...
          <Card.Text mode={webPage.themeMode} tag="p" style={{ fontWeight: 'bold' }} mobile="paragraphXS" desktop="paragraphMD">
            Visit the web site or github page
          </Card.Text>
          <Card.Text mode={webPage.themeMode} tag="p" as={Link} href={link} rel="noreferrer" target="_blank" mobile="paragraphXS" desktop="paragraphMD">
            {link}
          </Card.Text>
        </Box>
      </Box>
