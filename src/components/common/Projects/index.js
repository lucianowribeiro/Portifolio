  ...
  return (
    <WrapperProjects>
      <WrapperProjects.SectionTitle>
        <Text tag="h2" mobile="subTitleXS" desktop="subTitleMD">My Projects</Text>
      </WrapperProjects.SectionTitle>
      <WrapperProjects.SectionCard>
        {projects.map((project) => (
          <Card key={project.image} href={project.url} rel="noreferrer" target="_blank">
            <Card.Title><Text tag="h3" mobile="subTitleXS" desktop="subTitleMD">{project.title}</Text></Card.Title>
            <Card.Image src={project.image} alt="card image" />
            <Card.Text><Text tag="p" mobile="paragraphXS" desktop="paragraphMD">{project.text}</Text></Card.Text>
          </Card>
        ))}
      </WrapperProjects.SectionCard>
    </WrapperProjects>
